            ...
            <div className="max-w-[1320px] px-[15px] m-auto pt-[100px]">
                ...
                <div className='flex flex-col'>
                    <div className='text-center'>
                        ...
                        <h2 className="dots relative px-[10px] inline-flex mt-[30px] mb-[5px] text-[#09aff4] text-[15px] text-[1rem] font-[600] uppercase text-center justify-center">FAQs</h2>
                    </div>

                    <h2 className="mb-[50px] text-[1.5rem] md:text-[2.0rem] lg:text-[2.5rem] font-[500] text-white mb-[2px] capitalize text-center">frequently asked questions</h2>
