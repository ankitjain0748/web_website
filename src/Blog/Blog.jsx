        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] mb-[40px]'>
          <div className='rounded-[10px]'>
            ...
            <div className='bg-[#254bd54d] rounded-b-[10px] p-[20px]'>
              <div className='flex  flex-wrap md:flex-nowrap items-center gap-[5px] mb-[8px]'>
              ...
              <h2 className='mb-[15px] mt-[25px]'>
                <Link to={'/blog-page'} className='block max-w-[98%] text-[18px] md:text-[20px] lg:text-[25px] font-[600] leading-[28px] text-white truncate'>
              ...
              <div>
                <Link to="/blog-page" className='text-[#09aff4] text-[18px] font-[600] flex items-center gap-[5px] capitalize'>
                  read more
                  <FaArrowRight />
                </Link>
              </div>
